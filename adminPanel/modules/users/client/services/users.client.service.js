(function () {
  ...
  function UsersService($resource) {
    var Users = $resource('/api/users', {}, {
      ...
      changeStatus : {
        method : 'POST',
        url : '/api/changeUserStatus/:userId'

      },
      changeDeleteStatus : {
       method : 'POST',
       url : '/api/changeUserDeleteStatus/:userId'
    ...
    angular.extend(Users, {
      ...
      changeUserStatus: function (userId,data) {
        return this.changeStatus({
          userId: userId // api expects token as a parameter (i.e. /:userId)
        },data).$promise;
      },
      changeUserDeleteStatus: function (userId,data) {
        return this.changeDeleteStatus({
          userId: userId // api expects token as a parameter (i.e. /:userId)
        },data).$promise;
      },
